...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/08/26 06:35:00 by hawayda           #+#    #+#             */
/*   Updated: 2024/08/26 06:41:45 by hawayda          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../utils/headers/push_swap.h"

void	rotate_both_rr(t_stack_node **stack_a, t_stack_node **stack_b,
		int *pos_a, int *pos_b)
{
...
void	reverse_rotate_both_rrr(t_stack_node **stack_a, t_stack_node **stack_b,
		int *pos_a, int *pos_b)
{
	int	size_a;
	int	size_b;
